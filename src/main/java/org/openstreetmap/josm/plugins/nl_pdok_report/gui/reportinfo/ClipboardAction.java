...
public class ClipboardAction extends AbstractAction {
  private static final long serialVersionUID = -1711358369471975784L;
  /**
  ...
  /**
   * The component which is used as parent of the shown popup. If this is <code>null</code>, no popup will be shown.
   */
  ...
  /**
   * The contents that are transfered into the clipboard when the action is executed. If this is <code>null</code>, the
   * clipboard won't be changed.
   */
  ...
  /**
   * @param contents
   *          the contents, which should be copied to the clipboard when the {@link Action} is executed
   */
   ...
   * 
   * @param popupParent
   *          the component to set as parent of the popup
   */
